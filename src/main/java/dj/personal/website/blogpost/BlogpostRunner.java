...
public class BlogpostRunner implements CommandLineRunner {
	...
	private Collection<Blogpost> createBlogposts() {
		List<CompletableFuture<Blogpost>> completableFutures = new ArrayList<>();

		completableFutures.add(createBlogpost("blogpost.title.1", LocalDate.of(2018, Month.FEBRUARY, 12),
				"https://www.continuum.be/2018/02/12/hey-alexa-order-us-two-pizzas-please/", "Artificial Intelligence"));

		completableFutures.add(createBlogpost("Machine learning on source code", LocalDate.of(2018, Month.JUNE, 8),
				"https://www.continuum.be/2018/06/08/machine-learning-on-source-code/", "Artificial Intelligence"));

		completableFutures.add(createBlogpost("Deep Instinct – Malware detection using deep learning", LocalDate.of(2018, Month.NOVEMBER, 2),
				"https://www.continuum.be/2018/11/02/deep-instinct-malware-detection-using-deep-learning/", "Artificial Intelligence"));

		completableFutures.add(createBlogpost("Destructuring", LocalDate.of(2019, Month.MAY, 8),
				"https://www.continuum.be/2019/05/08/destructuring-javascript/", "Typescript"));

		completableFutures.add(createBlogpost("blogpost.title.5", LocalDate.of(2019, Month.DECEMBER, 7),
		...
		completableFutures.add(createBlogpost("blogpost.title.6", LocalDate.of(2020, Month.JANUARY, 9),
		...
		completableFutures.add(createBlogpost("blogpost.title.7", LocalDate.of(2020, Month.JANUARY, 22),
		...
		completableFutures.add(createBlogpost("blogpost.title.8", LocalDate.of(2020, Month.JANUARY, 29),
		...
		completableFutures.add(createBlogpost("blogpost.title.9", LocalDate.of(2020, Month.FEBRUARY, 3),
		...
		completableFutures.add(createBlogpost("blogpost.title.10", LocalDate.of(2020, Month.FEBRUARY, 8),
		...
		completableFutures.add(createBlogpost("blogpost.title.11", LocalDate.of(2020, Month.FEBRUARY, 21),
		...
		completableFutures.add(createBlogpost("blogpost.title.12", LocalDate.of(2020, Month.MARCH, 10),
		...
		completableFutures.add(createBlogpost("blogpost.title.13", LocalDate.of(2020, Month.MARCH, 22),
				"https://towardsdatascience.com/increase-your-face-recognition-models-accuracy-by-improving-face-contrast-a3e71bb6b9fb?source=friends_link&sk=a51fd37b38a9f9770fc424208c93a6a2",
				"Artificial Intelligence"));

		completableFutures.add(createBlogpost("blogpost.title.14", LocalDate.of(2020, Month.MARCH, 31),
		...
		completableFutures.add(createBlogpost("blogpost.title.15", LocalDate.of(2020, Month.APRIL, 20),
		...
		completableFutures.add(createBlogpost("blogpost.title.16", LocalDate.of(2020, Month.APRIL, 23),
		...
		completableFutures.add(createBlogpost("blogpost.title.17", LocalDate.of(2020, Month.APRIL, 29),
		...
		completableFutures.add(createBlogpost("blogpost.title.18", LocalDate.of(2020, Month.MAY, 10),
		...
		completableFutures.add(createBlogpost("blogpost.title.19", LocalDate.of(2020, Month.MAY, 17),
		...
		completableFutures.add(createBlogpost("blogpost.title.20", LocalDate.of(2020, Month.JUNE, 10),
		...
		completableFutures.add(createBlogpost("blogpost.title.21", LocalDate.of(2020, Month.JUNE, 15),
		...
		completableFutures.add(createBlogpost("blogpost.title.22", LocalDate.of(2020, Month.JUNE, 23),
		...
		completableFutures.add(createBlogpost("blogpost.title.23", LocalDate.of(2020, Month.JULY, 16),
		...
		if (blogposts.size() != completableFutures.size()) {
			log.error("Not all blogposts could be retrieved");
		}

		return blogpostRepository.saveAll(blogposts);
	}

	private CompletableFuture<Blogpost> createBlogpost(String title, LocalDate publicationDate, String url, String category) {
		CompletableFuture<BlogpostPreview> blogpostPreview = blogpostPreviewService.get(title, url);

		return blogpostPreview.thenApply(preview -> Blogpost.builder()
				.title(title)
				.publicationDate(publicationDate)
				.url(url)
				.base64image(preview.getImage())
				.category(category)
				.build());
	}
}
