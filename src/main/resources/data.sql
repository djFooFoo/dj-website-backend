...
VALUES (9781934356340, 'The Passionate Programmer: Creating a Remarkable Career in Software Development', 'Chad Fowler', 2019),
       (9781118957400, 'Oracle Certified Associate Java SE 8 Programmer I Study Guide', 'Jeanne Boyarsky, Scott Selikoff', 2016),
       (9781985170285, 'Ng-book: the complete book on Angular', 'Nathan Murray, Felipe Coury, Ari Lerner, Carlos Taborda', 2019),
       (9781119067900, 'Oracle Certified Professional Java SE 8 Programmer II Study Guide', 'Jeanne Boyarsky, Scott Selikoff', 2019),
       ...
       (9780596007126, 'Head First Design Patterns: A Brain-Friendly Guide', 'Elisabeth Freeman, Kathy Sierra', 2016),
